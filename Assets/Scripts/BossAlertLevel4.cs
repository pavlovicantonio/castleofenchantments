...
public class BossAlertLevel4 : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        sentences.Enqueue("Congratulations to the brave player for battling through and completing the fourth level...");
        sentences.Enqueue("... Just a little more, and you're on the final level, but don’t get too excited because another boss awaits you ...");
