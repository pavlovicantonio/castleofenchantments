...
public class Level2Story : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sentences.Enqueue("Congratulations on completing the first level! You have overcome the threats in Castlestone more easily than expected. ...");
        sentences.Enqueue("... But that’s not all... Up ahead lies the haunted forest, filled with dangers ...");
        sentences.Enqueue("... The enemies here are different from those on the previous level... be careful! ...");
        sentences.Enqueue("... Good luck, and don’t forget, the princess is waiting for you!");
